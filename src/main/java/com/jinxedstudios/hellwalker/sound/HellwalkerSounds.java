package com.jinxedstudios.hellwalker.sound;
...
public class HellwalkerSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(BuiltInRegistries.SOUND_EVENT, HellwalkerEngine.MODID);
    ...
    private static Supplier<SoundEvent> registerSoundEvent(String name) {
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(HellwalkerEngine.MODID, name);
