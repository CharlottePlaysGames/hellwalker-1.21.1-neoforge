...
public class UnwillingAttackGoal extends MeleeAttackGoal {
    private final UnwillingEntity entity;
    ...
    public UnwillingAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = ((UnwillingEntity) pMob);
    }
