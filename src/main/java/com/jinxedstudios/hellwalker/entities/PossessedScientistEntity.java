...
public class PossessedScientistEntity extends Monster {

    private static final EntityDataAccessor<Boolean> ATTACKING = SynchedEntityData.defineId(PossessedScientistEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new PossessedScientistAttackGoal(this, 0.5d, false));
